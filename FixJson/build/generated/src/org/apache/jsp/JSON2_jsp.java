...
public final class JSON2_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                                <li><a href=\"CheckValue_JSON.jsp\">JSON_1</a></li>\n");
      out.write("                                <li><a href=\"SendComment_JSON.jsp\">JSON_2</a></li>\n");
      out.write("                            </ul>\n");
      out.write("                        </li>\n");
      out.write("                    </ul>\n");
      ...
      out.write("                    <select class=\"list--items\" id=\"languages\">\n");
      ...
      out.write("                    value : \"\",\n");
      out.write("                }\n");
      out.write("                CheckValue.value = document.getElementById(\"languages\").value;\n");
      out.write("                var content = JSON.stringify(CheckValue);\n");
      out.write("                var xhttp = new XMLHttpRequest();\n");
      out.write("                xhttp.onreadystatechange = function () {\n");
      out.write("                    if (this.readyState == 4 && this.status == 200) {\n");
      out.write("                        document.getElementById(\"check\").innerHTML = \"Result:\";\n");
      out.write("                        document.getElementById(\"check\").innerHTML += ' ' + this.responseText;\n");
      out.write("                    }\n");
      out.write("                };\n");
      out.write("                xhttp.open(\"POST\", \"/FixJson/Servlet_JSON2\", true);\n");
